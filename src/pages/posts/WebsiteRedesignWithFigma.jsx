        ...
        <main className="article">
            <div className="article-container">
                ...
                <section className="one-column">
                    ...
                    <p>For a while, I’d been stuck in a bit of a design block. I’d scroll through incredible portfolios, admire the work shared in the Persona Slack group (which I’ve been fortunate to be a part of while at Boomerang), and come away feeling inspired, but also completely out of my depth. When you’re surrounded by talented designers, it’s easy to assume ideas should come naturally. Mine didn’t.</p>

                    <p>Eventually, I realised I was focusing too much on the results of great designers rather than their process. Developers (myself included) often jump straight into devtools or wireframes, but designers tend to think more deliberately. I kept noticing Figma pop up in their workflows, so I decided to give it a proper try before diving back into VS Code.</p>
                </section>
