            ...
            <main>
                ...
                <section id="knowledge">
                    <div className="content">
                        ...
                        <div className="container">
                            <div className="KST" id="knowledge_box_1">
                                <ul>
                                    <li>HTML5</li>
                                    <li>CSS3</li>
                                    <li>JavaScript</li>
                            ...
                            <div className="KST" id="knowledge_box_2">
                                <ul>
                                    <li>SQL</li>
                                    <li>React</li>
                                    <li>Firebase</li>
                            ...
                            <div className="KST" id="knowledge_box_3">
                                <ul>
                ...
                <section id="projects">
                    <div className="content">
                        ...
                        <div className="container">
                            <div className="project-box" id="LP">
                                <a href="https://github.com/HalfElfAlistair/nc-news.git" target="_blank" rel="noopener" className="project-tile">
                                    <p>Frontend Project: NC-News</p>
                                    <img src={ncNewsFrontendScreeny} alt="A screenshot from my Northcoders Frontend project." target="_blank" rel="noopener" />
                                </a>
                            </div>
                            <div className="project-box" id="SF">
                                <a href="https://github.com/HalfElfAlistair/nc_backend_project.git" target="_blank" rel="noopener" className="project-tile">
                                    <p>Backend Project: NC-News API</p>
                                    <img src={ncNewsBackendScreeny} alt="A screenshot from my Northcoders Backend project." target="_blank" rel="noopener" />
                                </a>
                            </div>
                        </div>
                    </div>
